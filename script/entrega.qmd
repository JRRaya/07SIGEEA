...
#| error: false
#| echo: false
MDE1 <- rast("data/mde/mde_idw_rec.tif")
MDE2 <- rast("data/mde/mde_tin_rec.tif")
plot(MDE1)
plot(MDE2)
```
...
teselas_normalizadas <- lapply(
  ...
  function(nombre) {
    opt_output_files(teselas) <- {
      dir_p <- here::here("data/lidar/lidar2/norm", nombre)
      dir.create(dir_p, recursive = TRUE, showWarnings = FALSE)
      file.path(dir_p, paste0(nombre, "_{ORIGINALFILENAME}"))
